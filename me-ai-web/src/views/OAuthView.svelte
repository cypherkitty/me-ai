        ...
        <div class="flex items-center gap-3 p-3 rounded border border-success/25 bg-success/8">
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-xs text-muted-foreground truncate">
              {profile.emailAddress ?? "Gmail account"}
            </p>
          </div>
          <Badge
            variant="outline"
            class="text-success border-success/30 bg-success/10 shrink-0 text-[0.6rem]"
          >
            {tokenTTLMin}m left
          </Badge>
        </div>
      ...
      {:else}
        ...
        <div class="flex flex-col gap-3">
          <p class="text-sm text-muted-foreground leading-relaxed">
            Sign in with Google to let me-ai read and manage your Gmail messages for automated
            pipeline processing.
          </p>
