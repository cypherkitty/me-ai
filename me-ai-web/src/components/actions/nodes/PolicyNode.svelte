...
<div class="flex flex-col bg-card rounded-xl w-[200px] border border-border shadow-sm">
  <div
    class="px-3 py-2 text-[10px] font-bold rounded-t-xl bg-secondary border-b border-border flex items-center gap-1.5 uppercase tracking-wider text-muted-foreground"
  >
