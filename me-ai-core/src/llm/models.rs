    ...
    vec![
        ...
        OllamaModelGroup {
            ...
            models: vec![
                ...
                OllamaModel { name: "gemma4:26b".to_string(), display_name: "Gemma 4 26B".to_string(), params: "26B MoE".to_string(), context_window: 256_000, max_email_tokens: 100_000, description: "Google Gemma 4 26B MoE, 256k context, 4B active params".to_string(), tags: vec!["google".to_string(), "multimodal".to_string(), "advanced".to_string()], recommended: true, recommended_for_email_processing: true },
                OllamaModel { name: "gemma4:31b".to_string(), display_name: "Gemma 4 31B".to_string(), params: "31B".to_string(), context_window: 256_000, max_email_tokens: 100_000, description: "Google Gemma 4 31B dense, 256k context, best quality".to_string(), tags: vec!["google".to_string(), "multimodal".to_string(), "advanced".to_string()], recommended: true, recommended_for_email_processing: true },
            ],
        },
    ]
}
